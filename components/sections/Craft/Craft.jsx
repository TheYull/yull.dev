...
export function Craft() {
    ...
    return (
        <section className="section-shell section--black">
            <Container>
                <div className="lg:grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-[80px] items-stretch">
                    ...
                    <div className="order-1 lg:order-2 flex sm:justify-center">
                        <div className="h-[386px] lg:h-[640px] w-[600px]">
                            <img src="/photo/img_2.png" alt="Developer" className="h-full w-full object-cover rounded-[40px]"/>
                        </div>
                    </div>
                </div>  
            </Container>
